...
const AdvReports = () => {
    ...
    return (
        <div className={s.main}>
            <Title className={s.title} color={'#247ba0'} colorLine={'#247ba0'}>Advertiser/Reports</Title>

            <div className={s.navigate}>
                <div className={s.search_input}>
                    <FormControl fullWidth size={'medium'} variant="outlined">
                        <InputLabel htmlFor="outlined-adornment-password">Search by campaign name...</InputLabel>
                        <OutlinedInput
                            onChange={(e) => {
